...
![image](https://github.com/user-attachments/assets/5cfae071-77c6-4678-890f-ec4f594304cf)
ขั้นแรกกดdebug แสดงผล a=2 b=3 c=0 จากนั้นกด step into เรื่อยๆ a=2 b=3 cหายไป กดไปเรื่อยๆจนถึงบรรทัดที่9 วนแสดงผลเหมือนขั้นแรก
จนจบบรรทัดที่10 c=5 กดเรื่อยๆจนจบโปรแกรม
